...
def parse_args():
    ...
    parser.add_argument('--noise_target', type=float, default=0., help='standard deviation noise label (before '
                                                                      'thresholding)')
...
if __name__ == '__main__':
    ...
    train_loader, val_loader, test_loader = get_dataset(num_weights, batch_size, noise_data, noise_target)
